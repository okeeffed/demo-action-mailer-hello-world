...
Inside of `touch app/views/user_mailer/welcome_email.html.erb`, let's add the following:
          ...
          >
                    ...
                    >
                      <div class="f-fallback">
                        ...
                        >
                          ...
                          have you on board. To get the most out of [Product
                          Name], do this primary next step:
                        </p>
                        <!-- Action -->
                        <table
                          class="body-action"
           ...
           https://litmus.com/blog/a-guide-to-bulletproof-buttons-in-email-design -->
                        ...
                        <p
                          style="font-size: 16px; line-height: 1.625; color: #51545E; margin: .4em 0 1.1875em;"
                        >
                          You've started a <%= @trial_length %> day trial. You
                          can upgrade to a paying account or cancel any time.
                        </p>
                        <table
                          class="attributes"
                          width="100%"
